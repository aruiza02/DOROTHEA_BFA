...
app = Celery('attacks',broker='amqp://admin:mypass@rabbit:5672',backend='rpc://',include=['attacks.tasks_hydra'],broker_connection_max_retries=100)#, broker_pool_limit=0, broker_connection_timeout=180000000)
